...
1. Please make sure there is no [open issue](https://github.com/gr2m/octoherd-script-normalize-package-repository-field/issues?utf8=%E2%9C%93&q=is%3Aissue) yet.
...
```shell
git clone https://github.com/<your account name>/octoherd-script-normalize-package-repository-field.git
cd octoherd-script-normalize-package-repository-field
npm install
```
...
- Submit a pull request from your topic branch to the main branch on the `gr2m/octoherd-script-normalize-package-repository-field` repository.
